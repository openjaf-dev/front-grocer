module Dashboard
  module Sales
    class ProductController < BaseController
      def by_categories
        t=load_taxons
        subtree = ProductHelper::Tree.build_tree(t.children[0])
      ...
      def by_brands
        t=load_taxons
        subtree = ProductHelper::Tree.build_tree(t.children[1])
        @tags = subtree.get_tags
    ...
    #    ]
        ...
        all_taxons = [
          ...
          ["Categories","Dairy", "Cheeses", 67 ],
          ["Categories","Dairy", "Eggs" , 99],
          ["Categories","Dairy", "Milk", 34],
          ["Categories","Dairy", "Yogourt", 35 ],                  
